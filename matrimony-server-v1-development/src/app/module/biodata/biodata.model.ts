...
const biodataSchema = new Schema<IBiodata>(
  {
    ...
    personal: {
      dress: { type: String, default: "উত্তর দেয়া হয়নি" },
      prayerHabit: { type: String, default: "উত্তর দেয়া হয়নি" },
      maintainMahram: { type: String, default: false },
      quranReading: { type: String, default: false },
      fiqh: { type: String, default: "উত্তর দেয়া হয়নি" },
      entertainment: { type: String, default: false },
      healthIssues: { type: String, default: false },
      specialSkills: { type: String, default: "উত্তর দেয়া হয়নি" },
      favoriteBooks: [{ type: String }],
      height: { type: String, default: "উত্তর দেয়া হয়নি" },
      maritalStatus: { type: String, default: "উত্তর দেয়া হয়নি" },
      hobbies: [{ type: String }],
      skinColor: { type: String, default: "উত্তর দেয়া হয়নি" },
      bloodGroup: { type: String, default: "উত্তর দেয়া হয়নি" },
      weight: { type: String, default: "উত্তর দেয়া হয়নি" },
      personality: { type: String, default: "উত্তর দেয়া হয়নি" },
      favoriteFood: { type: String, default: "উত্তর দেয়া হয়নি" },
    },
